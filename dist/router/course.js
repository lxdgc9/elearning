...
const delete_1 = require("../handler/course/v1/delete");
const get_1 = require("../handler/course/v1/get");
const get_by_id_1 = require("../handler/course/v1/get-by-id");
const new_1 = require("../handler/course/v1/new");
const update_1 = require("../handler/course/v1/update");
